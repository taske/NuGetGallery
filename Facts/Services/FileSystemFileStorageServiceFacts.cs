    ...
    public class FileSystemFileStorgeServiceFacts
    {
        ...
        public class TheGetFileMethod
        {
            ...
            public void WillThrowIfFolderNameIsNull(string folderName)
            {
                ...
                var ex = Assert.Throws<ArgumentNullException>(
                    async () => await service.GetFileAsync(
                        folderName,
                        "theFileName"));
        ...
        public class TheSaveFileMethod
        {
            ...
            public void WillThrowIfFolderNameIsNull(string folderName)
            {
                ...
                var ex = Assert.Throws<ArgumentNullException>(async () => await service.SaveFileAsync(folderName, "theFileName", CreateFileStream()));
            ...
            public void WillThrowIfFileNameIsNull(string fileName)
            {
                ...
                var ex = Assert.Throws<ArgumentNullException>(async () => await service.SaveFileAsync("theFolderName", fileName, CreateFileStream()));
            ...
            public void WillThrowIfFileStreamIsNull()
            {
                ...
                var ex = Assert.Throws<ArgumentNullException>(async () => await service.SaveFileAsync("theFolderName", "theFileName", null));
